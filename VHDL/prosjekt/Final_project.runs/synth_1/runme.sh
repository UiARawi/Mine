...
HD_PWD='C:/Users/Rawi/Documents/UiA/Vr_19/ELE_112/Lab/prosjekt/Final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Final_prosjekt_top_file.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Final_prosjekt_top_file.tcl
