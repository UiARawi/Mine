...
HD_PWD='C:/Users/Rawi/Documents/UiA/Vr_19/ELE_112/Lab/prosjekt/Final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Final_prosjekt_top_file.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Final_prosjekt_top_file.tcl -notrace
